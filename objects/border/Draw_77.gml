if (_enabled) {
    ...
    if (sprite_exists(_sprite_previous)) {
        draw_sprite_ext(
            _sprite_previous, _index, // <<--- aqui
            (SW - 960 * SF) / 2, (SH - 540 * SF) / 2,
            960 / sprite_get_width(_sprite_previous) * SF,
            540 / sprite_get_height(_sprite_previous) * SF,
            0, c_white, 1
        );
    } else {
    ...
    if (sprite_exists(_sprite)) {
        draw_sprite_ext(
            _sprite, _index, // <<--- aqui
            (SW - 960 * SF) / 2, (SH - 540 * SF) / 2,
            960 / sprite_get_width(_sprite) * SF,
            540 / sprite_get_height(_sprite) * SF,
            0, c_white, _alpha
        );
    } else {
