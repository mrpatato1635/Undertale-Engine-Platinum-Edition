function Item_Custom(){
	{
		...
		#macro ITEM_PIE "pie"
		itemTypes.Register(ITEM_PIE, new CustomItem_Pie());
		
		#macro ITEM_INSTANT_NOODLES "instant.noodles"
		itemTypes.Register(ITEM_INSTANT_NOODLES, new CustomItem_Instant_Noodles());
					
		#macro ITEM_FACE_STEAK "steak"
		itemTypes.Register(ITEM_FACE_STEAK, new CustomItem_Face_Steak());
		
		#macro ITEM_SNOWMAN_PIECE "snowman_piece"
		itemTypes.Register(ITEM_SNOWMAN_PIECE, new CustomItem_Snowman_Piece());
		
		#macro ITEM_LEGENDARY_HERO "legendary_hero"
		itemTypes.Register(ITEM_LEGENDARY_HERO, new CustomItem_Legendary_Hero());
